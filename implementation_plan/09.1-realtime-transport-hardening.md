...
These are **pre-existing conflict-quality issues**, not regressions from transport changes. Tracked in [techncial-dept.md](../techncial-dept.md); fix scheduled in [09.2-offline-conflict-quality.md](09.2-offline-conflict-quality.md) **after M1b crypto**.
...
- [techncial-dept.md](../techncial-dept.md) — technical debt register
