...
**Current focus:** Phase 28 — Production storage (M1d); M1c core complete  
...
| 28 | [28-production-storage-architecture.md](28-production-storage-architecture.md) | Supabase Storage, bandwidth (M1d) | in progress |
